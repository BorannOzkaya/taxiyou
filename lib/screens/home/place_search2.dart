...
class PlaceDeneme2 extends StatefulWidget {
  @override
  _PlaceDeneme2State createState() => _PlaceDeneme2State();
}

class _PlaceDeneme2State extends State<PlaceDeneme2> {
  ...
  void getDetils(String placeId) async {
    ...
    if (result != null && result.result != null && mounted) {
      setState(() {
        ...
        var lng = detailsResult!.geometry!.location!.lng.toString();
